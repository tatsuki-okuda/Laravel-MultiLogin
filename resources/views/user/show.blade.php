            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="md:flex md:justify-around">
                        ...
                        <div class="md:w-1/2 ml-4">
                            ...
                            <div class="flex justify-around items-center">
                                <span class="title-font font-medium text-2xl text-gray-900">{{ number_format($product->price)  }}円（税込み）</span>
                    ...
                    <div class="mb-4 text-center" >
                        <button data-micromodal-trigger="modal-1" href='javascript:;' type=“button” class="ml-auto text-white bg-gray-400 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">ショップの詳細をみる</button>
                    </div>
                </div>
            </div>
        </div>
