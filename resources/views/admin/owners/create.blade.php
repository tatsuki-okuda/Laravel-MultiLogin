                        ...
                        <div class="container px-5  mx-auto">
                            <div class="flex flex-col text-center w-full mb-12">
                                ...
                                <div class=" -m-2">
                                    ...
                                    <div class="p-2 w-1/2 mx-auto">
                                        <div class="relative">
                                            <label for="password_password_confirmation" class="leading-7 text-sm text-gray-600">パスワード（確認）</label>
                                            <input type="password" id="password_password_confirmation" name="password_password_confirmation" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        </div>
                                    </div>
